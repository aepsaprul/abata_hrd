...
class NavigasiController extends Controller
{
    ...
    {
        $nav_main = HcNavigasiMain::get();
        $nav_sub = HcNavigasiSub::orderBy('id', 'asc')->orderBy('main_id', 'asc')->get();
        $nav_tombol = HcNavigasiButton::orderBy('id', 'asc')->orderBy('main_id', 'asc')->orderBy('sub_id', 'asc')->get();
    ...
    {
        $nav_tombol = new HcNavigasiButton;
    ...
    {
        $nav_main = HcNavigasiMain::find($id);
    ...
    {
        $nav_tombol = HcNavigasiButton::find($id);
        $nav_main = HcNavigasiMain::get();
        $nav_sub = HcNavigasiSub::get();
    ...
    {
        $nav_main = HcNavigasiMain::find($request->id);
        $nav_main->title = $request->title;
        $nav_main->link = $request->link;
        $nav_main->icon = $request->icon;
        $nav_main->aktif = $request->aktif;
    ...
    {
        $nav_sub = HcNavigasiSub::find($request->id);
        $nav_sub->title = $request->title;
        $nav_sub->link = $request->link;
        $nav_sub->main_id = $request->main_id;
        $nav_sub->aktif = $request->aktif;
        ...
        $nav_main = HcNavigasiMain::find($request->main_id);
    ...
    {
        $nav_tombol = HcNavigasiButton::find($request->id);
        $nav_tombol->title = $request->title;
        $nav_tombol->link = $request->link;
        $nav_tombol->sub_id = $request->sub_id;
        $nav_tombol->main_id = $request->main_id;
        ...
        $nav_main = HcNavigasiMain::find($request->main_id);
        $nav_sub = HcNavigasiSub::find($request->sub_id);
    ...
    public function mainDelete(Request $request)
    {
        ...
        $nav_sub = HcNavigasiSub::where('main_id', $request->id)->first();
