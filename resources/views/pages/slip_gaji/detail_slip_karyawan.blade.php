...
<body>
    ...
    @if ($slip_detail)
        ...
        <tr>
          ...
          <td style="text-align: center; text-transform: uppercase; vertical-align: top;">
            <table style="width: 100%; padding-left: 10px; padding-right: 10px;" border="0">
              ...
              <tr>
                <td style="text-align: left; font-size: 10px;">telat kehadiran :</td>
                <td style="text-align: right; text-transform: capitalize;">{{ $slip_detail->telat_kehadiran }} hari</td>
              </tr>
              <tr>
      ...
      <div style="margin-top: 20px;">
        ...
        <p style="padding: 0; margin: 0;"><span style="text-transform: capitalize; font-size: 10px; color: red; font-style: italic;">*Apabila karyawan berangkat diatas jam 7.50 dan 12.00, maka tunjangan kehadiran akan terpotong</p>
      </div>
    @else
