...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
        <h1>Abata Peduli - <span class="h5">Approver</span></h1>
        </div>
        <div class="col-sm-6">
...
<script>
  $(document).ready(function () {
    ...
    function approverData() {
      $.ajax({
        url: "{{ URL::route('abdul.approver.data') }}",
        type: 'GET',
    ...
    $('#btn-create').on('click', function() {
      $.ajax({
        url: "{{ URL::route('abdul.approver.create') }}",
        type: 'GET',
        success: function (response) {
          // role
    ...
    $(document).on('submit', '.form-create', function (e) {
      ...
      $.ajax({
        url: "{{ URL::route('abdul.approver.store') }}",
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
    ...
    $(document).on('change', '.select2', function () {
      ...
      timer = setTimeout(() => {
        ...
        $.ajax({
          url: "{{ URL::route('abdul.approver.update') }}",
          type: 'POST',
          data: formData,
          success: function (response) {
            Toast.fire({
    ...
    $(document).on('click', '#btn-approve-add', function (e) {
      ...
      $.ajax({
        url: "{{ URL::route('abdul.approver.add') }}",
        type: 'POST',
        data: formData,
        beforeSend: function () {
    ...
    $('body').on('click', '.btn-delete', function (e) {
      ...
      var url = '{{ route("abdul.approver.delete_all_btn", ":id") }}';
    ...
    $('#form-delete').submit(function (e) {
      ...
      $.ajax({
        url: "{{ URL::route('abdul.approver.delete_all') }}",
        type: 'POST',
        data: formData,
        beforeSend: function () {
    ...
    $('body').on('click', '.btn-delete-approve', function (e) {
      ...
      var id = $(this).attr('data-id');
      var url = '{{ route("abdul.approver.delete_btn", ":id") }}';
      url = url.replace(':id', id);
    ...
    $('#form-delete').submit(function (e) {
      ...
      $.ajax({
        url: "{{ URL::route('abdul.approver.delete') }}",
        type: 'POST',
        data: formData,
        beforeSend: function () {
          $('.btn-delete-spinner').css('display', 'block');
