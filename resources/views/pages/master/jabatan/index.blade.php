        ...
        <div class="modal-content">
            <form id="form-create">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="create_nama" class="form-label">Nama Jabatan</label>
                        <input type="text"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="form-edit">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="edit_nama" class="form-label">Nama Jabatan</label>
                        <input type="text"
                            class="form-control form-control-sm"
                            id="edit_nama"
                            name="edit_nama"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#form-edit').submit(function (e) {
            ...
            var id = $('#edit_id').val();
            var url = '{{ route("jabatan.update", ":id") }}';
            url = url.replace(':id', id);
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            var id = $(this).attr('data-id');
            var url = '{{ route("jabatan.delete_btn", ":id") }}';
            url = url.replace(':id', id);
