...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Approver Penggajian</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Approver Penggajian</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script>
    $(document).ready(function () {
        ...
        function dataPenggajian() {
            $.ajax({
                url: "{{ URL::route('penggajian_approver.get_penggajian') }}",
                type: 'GET',
        ...
        $('#btn-create').on('click', function() {
            $.ajax({
                url: "{{ URL::route('penggajian_approver.create') }}",
                type: 'GET',
                success: function (response) {
                    // role
        ...
        $(document).on('submit', '.form-create', function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('penggajian_approver.store') }}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $(document).on('change', '.select2', function () {
            ...
            timer = setTimeout(() => {
                ...
                $.ajax({
                    url: "{{ URL::route('penggajian_approver.update_approver') }}",
                    type: 'POST',
                    data: formData,
                    success: function (response) {
                        Toast.fire({
        ...
        $(document).on('click', '#btn-approve-add', function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('penggajian_approver.add_approver') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            var url = '{{ route("penggajian_approver.delete_btn", ":id") }}';
        ...
        $('#form-delete').submit(function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('penggajian_approver.delete') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
        ...
        $('body').on('click', '.btn-delete-approve', function (e) {
            ...
            var id = $(this).attr('data-id');
            var url = '{{ route("penggajian_approver.delete_btn_approver", ":id") }}';
            url = url.replace(':id', id);
        ...
        $('#form-delete').submit(function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('penggajian_approver.delete_approver') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
                    $('.btn-delete-spinner').css('display', 'block');
