                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-indigo">Nama Divisi</th>
                                        <th class="text-center text-indigo">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($divisis as $key => $item)
                                        <tr>
        ...
        <div class="modal-content">
            <form id="form-create">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="create_nama" class="form-label">Nama Divisi</label>
                        <input type="text"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#form-edit').submit(function (e) {
            ...
            var id = $('#edit_id').val();
            var url = '{{ route("divisi.update", ":id") }}';
            url = url.replace(':id', id);
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            var id = $(this).attr('data-id');
            var url = '{{ route("divisi.delete_btn", ":id") }}';
            url = url.replace(':id', id);
