<table border="1">
    <thead>
        <tr>
            ...
            <th style="background-color: lightblue; font-weight: bold; text-align: center;">PIC</th>
            <th style="background-color: lightblue; font-weight: bold; text-align: center;">Nama Instansi</th>
    ...
    <tbody>
        @foreach ($data_instansi as $key => $item)
            <tr>
                <td>{{ $key + 1 }}</td>
                <td>
                    @if ($item->karyawan)
