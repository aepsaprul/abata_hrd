                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="medsos">
                                    ...
                                    <div class="medsos_notif font-italic text-success mb-3 mt-3"></div>
                                    <div id="medsos_data">
                                ...
                                <div class="tab-pane" id="sebelum_menikah">
                                    ...
                                    <div class="sebelum_menikah_notif font-italic text-success mb-3 mt-3"></div>
                                    <div id="sebelum_menikah_data">
                                ...
                                <div class="tab-pane" id="setelah_menikah">
                                    ...
                                    <div class="setelah_menikah_notif font-italic text-success mb-3 mt-3"></div>
                                    <div id="setelah_menikah_data">
                                ...
                                <div class="tab-pane" id="kerabat_darurat">
                                    ...
                                    <div class="kerabat_darurat_notif font-italic text-success mb-3 mt-3"></div>
                                    <div id="kerabat_darurat_data">
                                ...
                                <div class="tab-pane" id="pendidikan">
                                    ...
                                    <div class="pendidikan_notif font-italic text-success mb-3 mt-3"></div>
                                    <div id="pendidikan_data">
	...
	$(document).ready(function () {
        ...
        function medsos() {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    var medsos_data = "<table class=\"table table-bordered\">" +
                        "<tr class=\"bg-primary\">" +
                    ...
                    medsos_data += "</table>";
                    $('#medsos_data').append(medsos_data);
                }
            });
        }
        ...
        $('#medsos_form').submit(function(e) {
            ...
            if ($('#nama_media_sosial').val() == "" || $('#nama_akun').val() == "") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#medsos_data').empty();
                        $('.medsos_notif').append(response.status);
                        medsos();
        ...
        function sebelumMenikah() {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    var sebelum_menikah_data = "<table class=\"table table-bordered\">" +
                        "<tr class=\"bg-primary\">" +
                    ...
                    sebelum_menikah_data += "</table>";
                    $('#sebelum_menikah_data').append(sebelum_menikah_data);
                }
            });
        }
        ...
        $('#sebelum_menikah_form').submit(function(e) {
            ...
            if ($('#sebelum_menikah_hubungan').val() == "" || $('#sebelum_menikah_nama').val() == "" || $('#sebelum_menikah_usia').val() == "" || $('#sebelum_menikah_jenis_kelamin').val() == "" || $('#sebelum_menikah_pendidikan').val() == "" || $('#sebelum_menikah_pekerjaan').val() == "") {
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(response) {
                        $('#sebelum_menikah_data').empty();
                        $('.sebelum_menikah_notif').append(response.status);
                        sebelumMenikah();
        ...
        function setelahMenikah() {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    var setelah_menikah_data = "<table class=\"table table-bordered\">" +
                        "<tr class=\"bg-primary\">" +
                            "<th class=\"text-center\">Hubungan</th>" +
                            "<th class=\"text-center\">Nama</th>" +
                    ...
                    setelah_menikah_data += "</table>";
                    $('#setelah_menikah_data').append(setelah_menikah_data);
                }
            });
        }
        ...
        $('#setelah_menikah_form').submit(function(e) {
            ...
            if ($('#setelah_menikah_hubungan').val() == "" || $('#setelah_menikah_nama').val() == "" || $('#setelah_menikah_tempat_lahir').val() == "" || $('#setelah_menikah_tanggal_lahir').val() == "" || $('#setelah_menikah_pekerjaan').val() == "") {
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(response) {
                        $('#setelah_menikah_data').empty();
                        $('.setelah_menikah_notif').append(response.status);
                        setelahMenikah();
        ...
        function kerabatDarurat() {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    var kerabat_darurat_data = "<table class=\"table table-bordered\">" +
                        "<tr class=\"bg-primary\">" +
                            "<th class=\"text-center\">Hubungan</th>" +
                            "<th class=\"text-center\">Nama</th>" +
                            "<th class=\"text-center\">Jenis Kelamin</th>" +
                    ...
                    kerabat_darurat_data += "</table>";
                    $('#kerabat_darurat_data').append(kerabat_darurat_data);
                }
            });
        }
        ...
        $('#kerabat_darurat_form').submit(function(e) {
            ...
            if ($('#kerabat_darurat_hubungan').val() == "" || $('#kerabat_darurat_nama').val() == "" || $('#kerabat_darurat_jenis_kelamin').val() == "" || $('#kerabat_darurat_telepon').val() == "" || $('#kerabat_darurat_alamat').val() == "") {
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(response) {
                        $('#kerabat_darurat_data').empty();
                        $('.kerabat_darurat_notif').append(response.status);
                        kerabatDarurat();
        ...
        function pendidikan() {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    var pendidikan_data = "<table class=\"table table-bordered\">" +
                        "<tr class=\"bg-primary\">" +
                    ...
                    pendidikan_data += "</table>";
                    $('#pendidikan_data').append(pendidikan_data);
                }
            });
        }
        ...
        $('#pendidikan_form').submit(function(e) {
            ...
            if ($('#pendidikan_tingkat').val() == "" || $('#pendidikan_nama').val() == "" || $('#pendidikan_kota').val() == "" || $('#pendidikan_jurusan').val() == "" || $('#pendidikan_tahun_masuk').val() == "" || $('#pendidikan_tahun_lulus').val() == "") {
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(response) {
                        $('#pendidikan_data').empty();
                        $('.pendidikan_notif').append(response.status);
                        pendidikan();
