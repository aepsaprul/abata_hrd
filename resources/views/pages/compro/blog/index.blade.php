                    ...
                    <div class="card">
                        {{-- @if (in_array("tambah", $current_data_navigasi)) --}}
                            <div class="card-header">
                              <form action="{{ route('compro.blog.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="create_judul" id="create_judul" class="form-control" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="form-group">
                                      <label for="create_gambar">Gambar</label>
                                      <input type="file" name="create_gambar" id="create_gambar" class="form-control" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                      <label for="create_deskripsi">Deskripsi</label>
                                      <textarea id="summernote" name="create_deskripsi"></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- @if (in_array("ubah", $current_data_navigasi)) --}}
                                                                <a
                                                                    href="{{ route('compro.blog.edit', [$item->id]) }}"
...
<script>
    $(document).ready(function () {
        ...
        $('#form-delete').submit(function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('compro.blog.delete') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
