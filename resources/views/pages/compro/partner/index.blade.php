                    ...
                    <div class="card">
                        {{-- @if (in_array("tambah", $current_data_navigasi)) --}}
                            <div class="card-header">
                              <form action="{{ route('compro.partner.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- @if (in_array("ubah", $current_data_navigasi)) --}}
                                                                <a
                                                                    href="{{ route('compro.partner.edit', [$item->id]) }}"
...
<script>
    $(document).ready(function () {
        ...
        $('#form-delete').submit(function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('compro.partner.delete') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
