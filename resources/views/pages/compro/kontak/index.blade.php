                            ...
                            <div class="card-header">
                              <form action="{{ route('compro.kontak.store') }}" method="POST">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                      <label for="create_img">Img</label>
                                      <input type="text" name="create_img" id="create_img" class="form-control" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                      <label for="create_nomor">Nomor</label>
                                      <input type="text" name="create_nomor" id="create_nomor" class="form-control" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                      <label for="create_link">Link</label>
                                      <input type="text" name="create_link" id="create_link" class="form-control">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-indigo">Img</th>
