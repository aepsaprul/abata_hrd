                    ...
                    <div class="card">
                        {{-- @if (in_array("tambah", $current_data_navigasi)) --}}
                            <div class="card-header">
                              <form action="{{ route('compro.testimoni.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="form-group">
                                      ...
                                      <input type="file" name="create_foto" id="create_foto" class="form-control">
                                    </div>
                                  </div>
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
                                    <div class="form-group">
                                      <label for="create_komentar">Komentar</label>
                                      <textarea name="create_komentar" id="create_komentar" cols="30" rows="3" class="form-control" required></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-indigo">Komentar</th>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- @if (in_array("ubah", $current_data_navigasi)) --}}
                                                                <a
                                                                    href="{{ route('compro.testimoni.edit', [$item->id]) }}"
...
<script>
    $(document).ready(function () {
        ...
        $('#form-delete').submit(function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('compro.testimoni.delete') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
