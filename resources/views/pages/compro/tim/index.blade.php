                    ...
                    <div class="card">
                        {{-- @if (in_array("tambah", $current_data_navigasi)) --}}
                            <div class="card-header">
                              <form action="{{ route('compro.tim.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                  ...
                                  <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="create_jabatan" id="create_jabatan" class="form-control" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                    <div class="form-group">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            {{-- @if (in_array("ubah", $current_data_navigasi)) --}}
                                                                <a
                                                                    href="{{ route('compro.tim.edit', [$item->id]) }}"
...
<script>
    $(document).ready(function () {
        ...
        $('#form-delete').submit(function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('compro.tim.delete') }}",
                type: 'POST',
                data: formData,
                beforeSend: function () {
