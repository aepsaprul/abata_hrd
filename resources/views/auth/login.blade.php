...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset(env('APP_URL_IMG') . 'themes/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- Theme style -->
...
<body class="hold-transition login-page">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <div class="social-auth-links text-center mt-4 mb-3">
                    <img src="{{ asset(env('APP_URL_IMG') . 'themes/dist/img/logo-biru.png') }}" alt="logo-abata" style="max-width: 100px;">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset(env('APP_URL_IMG') . 'themes/dist/js/adminlte.min.js') }}"></script>
