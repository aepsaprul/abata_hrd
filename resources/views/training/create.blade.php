										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="judul" id="judul" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="durasi" id="durasi" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="peserta" id="peserta" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="tempat" id="tempat" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="goal" id="goal" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="pengisi" id="pengisi" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="hasil" id="hasil" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
										...
										<div class="col-md-3">
											...
											<dl class="row">
												...
												<dd class="col-sm-10 border-bottom border-warning rounded p-2">
													...
													<input type="text" name="status" id="status" style="border: none; width: 100%;" onkeyup="this.value = this.value.toUpperCase()">
