...
Route::group(['middleware' => 'auth'], function () {
  ...
  Route::put('/struktur/{id}/update', [StrukturController::class, 'update'])->name('struktur.update');
  Route::get('/struktur/{id}/delete', [StrukturController::class, 'delete'])->name('struktur.delete');
  Route::get('/struktur/display', [StrukturController::class, 'display'])->name('struktur.display');
  Route::get('/struktur/get_struktur', [StrukturController::class, 'getStruktur'])->name('struktur.get');
});
